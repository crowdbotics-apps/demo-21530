...
export class Blank extends React.Component {
  ...
  state = { TextInput_18: "", TextInput_16: "", Switch_14: true }
  render = () => (
        ...
        <View style={styles.View_6}>
          <TextInput
            ...
            onChangeText={nextValue =>
              this.setState({ TextInput_18: nextValue })
            }
          />
          <TextInput
            placeholder="Sample text input placeholder"
            ...
            onChangeText={nextValue =>
              this.setState({ TextInput_16: nextValue })
            }
          />
          <Switch
            activeColor="#409EFF"
            ...
            onValueChange={nextChecked =>
              this.setState({ Switch_14: nextChecked })
            }
          />
          <Button
            title="Press me!"
